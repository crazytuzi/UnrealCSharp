...
namespace Script.Reflection.Delegate
{
    public static class MulticastDelegateUtils
    {
        ...
        public static unsafe Boolean MulticastDelegate_Contains<T>(void* InAddress, T InMulticastDelegate) where T : System.Delegate=>
            MulticastDelegateImplementation.MulticastDelegate_ContainsImplementation(InAddress, InMulticastDelegate);
        
        public static unsafe void MulticastDelegate_Add<T>(void* InAddress, T InMulticastDelegate)  where T : System.Delegate=>
            MulticastDelegateImplementation.MulticastDelegate_AddImplementation(InAddress, InMulticastDelegate);

        public static unsafe void MulticastDelegate_AddUnique<T>(void* InAddress, T InMulticastDelegate)  where T : System.Delegate=>
            MulticastDelegateImplementation.MulticastDelegate_AddUniqueImplementation(InAddress, InMulticastDelegate);

        public static unsafe void MulticastDelegate_Remove<T>(void* InAddress,T InMulticastDelegate)  where T : System.Delegate=>
        ...
        public static unsafe void MulticastDelegate_Broadcast(void* InAddress, out ObjectList OutValue,
