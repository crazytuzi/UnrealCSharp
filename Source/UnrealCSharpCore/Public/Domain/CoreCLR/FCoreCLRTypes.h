...
typedef IManagedHandle (*handle_data_alloc_fn)(PTRINT, int32);

typedef IManagedHandle (*handle_data_alloc_weak_ref_fn)(PTRINT, int32);

typedef PTRINT (*handle_data_get_target_fn)(IManagedHandle);

typedef void (*handle_data_free_fn)(IManagedHandle);

typedef void (*log_bridge_set_log_fn)(PTRINT);

typedef void (*log_bridge_initialize_fn)();

typedef void (*log_bridge_deinitialize_fn)();
...
typedef PTRINT (*array_bridge_array_get_fn)(IManagedHandle, int32);

typedef IManagedHandle (*array_bridge_array_get_ref_fn)(IManagedHandle, int32);
