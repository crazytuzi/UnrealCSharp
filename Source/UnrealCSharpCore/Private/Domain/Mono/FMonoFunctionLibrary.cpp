...
TArray<FString> FMonoFunctionLibrary::GetAssemblyPath()
{
	return TArrayBuilder<FString>().
	       Add(FPaths::ProjectContentDir() / FUnrealCSharpFunctionLibrary::GetPublishDirectory()).
	       Add(GetNetDirectory()).
	       Build();
}

UAssemblyLoader* FMonoFunctionLibrary::GetAssemblyLoader()
{
