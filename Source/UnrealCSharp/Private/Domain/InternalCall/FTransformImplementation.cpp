                                                                      ...
                                                                      MonoObject* InSourceString)
{
	...
	{
		return Transform->InitFromString(FCSharpEnvironment::GetEnvironment()->GetDomain()->String_To_UTF8(
...
void FTransformImplementation::Transform_InverseImplementation(const MonoObject* InMonoObject, MonoObject** OutValue)
{
	...
	const auto FoundMonoClass = FCSharpEnvironment::GetEnvironment()->GetDomain()->Class_From_Name(
		FTypeBridge::GetClassNameSpace(CLASS_SCRIPT_STRUCT(FTransform)),
