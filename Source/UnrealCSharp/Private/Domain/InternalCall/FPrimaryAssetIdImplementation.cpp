	...
	FRegisterPrimaryAssetId()
	{
		TReflectionClassBuilder<FPrimaryAssetId>(NAMESPACE_BINDING)
			...
			.Constructor(BINDING_CONSTRUCTOR(FPrimaryAssetId, const FString&),
			             {"TypeAndName"})
			.Property("PrimaryAssetTypeTag", BINDING_PROPERTY(&FPrimaryAssetId::PrimaryAssetTypeTag))
			.Property("PrimaryAssetNameTag", BINDING_PROPERTY(&FPrimaryAssetId::PrimaryAssetNameTag))
