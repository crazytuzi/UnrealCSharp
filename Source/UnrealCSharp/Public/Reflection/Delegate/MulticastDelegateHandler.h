...
public:
	...
	void Add(UObject* InObject, FMethodReflection* InMethod);

	void AddUnique(UObject* InObject, FMethodReflection* InMethod);

	void Remove(UObject* InObject, FMethodReflection* InMethod);
