...
public:
	...
	PRIMITIVE_PROPERTY_IMPLEMENTATION_DEFINE(UInt64, uint64)
	...
	COMPOUND_PROPERTY_IMPLEMENTATION_DEFINE(Class, MonoObject)

	COMPOUND_PROPERTY_IMPLEMENTATION_DEFINE(Interface, MonoObject)

	COMPOUND_PROPERTY_IMPLEMENTATION_DEFINE(Array, MonoObject)

	COMPOUND_PROPERTY_IMPLEMENTATION_DEFINE(WeakObject, MonoObject)

	COMPOUND_PROPERTY_IMPLEMENTATION_DEFINE(LazyObject, MonoObject)

	COMPOUND_PROPERTY_IMPLEMENTATION_DEFINE(SoftObject, MonoObject)
	...
	COMPOUND_PROPERTY_IMPLEMENTATION_DEFINE(FieldPath, MonoObject)
};
