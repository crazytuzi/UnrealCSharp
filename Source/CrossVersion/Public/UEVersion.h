...
#define UE_SOFT_OBJECT_PATH_SET_SUB_PATH_STRING !UE_VERSION_START(5, 6, 0)

#define UE_CLASS_CLASS_DEFAULT_OBJECT !UE_VERSION_START(5, 6, 0)

#define UE_F_UTF8_STR_PROPERTY UE_VERSION_START(5, 6, 0)

#define UE_F_ANSI_STR_PROPERTY UE_VERSION_START(5, 6, 0)

#define UE_GUID_PARSE_F_STRING_F_GUID UE_VERSION_START(5, 6, 0)

#define UE_GUID_PARSE_EXACT_F_STRING_E_GUID_FORMATS_F_GUID UE_VERSION_START(5, 6, 0)

#define UE_SOFT_OBJECT_PATH_GET_OR_CREATE_ID_FOR_OBJECT_U_OBJECT UE_VERSION_START(5, 6, 0)

#define UE_CLASS_SET_DEFAULT_OBJECT UE_VERSION_START(5, 6, 0)
