...
#define UE_GUID_PARSE !UE_VERSION_START(5, 6, 0)

#define UE_GUID_PARSE_EXACT !UE_VERSION_START(5, 6, 0)

#define UE_SOFT_OBJECT_PATH_SET_SUB_PATH_STRING !UE_VERSION_START(5, 6, 0)

#define UE_SOFT_OBJECT_PATH_GET_OR_CREATE_ID_FOR_OBJECT !UE_VERSION_START(5, 6, 0)

#define UE_SET_CLASS_DEFAULT_OBJECT UE_VERSION_START(5, 6, 0)

#define UE_F_COLLECTION_REF UE_VERSION_START(5, 6, 0)

#define UE_E_OBJECT_FLAGS_RF_KEEP_FOR_COOKER !UE_VERSION_START(5, 6, 0)

#define UE_GET_DEFAULT_UOBJECT UE_VERSION_START(5, 6, 0)
