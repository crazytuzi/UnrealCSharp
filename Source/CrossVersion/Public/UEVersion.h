...
#define UE_GET_MODULE_NAME_T_OBJECT_PTR UE_VERSION_START(5, 3, 0)

#define UE_GET_OUTER_NAME_T_OBJECT_PTR UE_VERSION_START(5, 3, 0)

#define UE_GET_OUTER_RELATIVE_PATH_T_OBJECT_PTR UE_VERSION_START(5, 3, 0)

#define UE_GET_MODULE_RELATIVE_PATH_T_OBJECT_PTR UE_VERSION_START(5, 3, 0)
