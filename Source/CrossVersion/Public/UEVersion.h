...
#define UE_TOP_LEVEL_ASSET_PATH UE_VERSION_START(5, 1, 0)

#define UE_OBJECT_PATH UE_VERSION_START(5, 1, 0)

#define UE_INLINE_GENERATED UE_VERSION_START(5, 1, 0)

#define UE_NAME_PERMISSION_LIST !UE_VERSION_START(5, 1, 0)

#define UE_ITEM_DATA_TRY_GET_COLLECTION_ID_PROPERTY !UE_VERSION_START(5, 1, 0)
...
#define UE_ITEM_TAG_PLUGIN UE_VERSION_START(5, 4, 0)
