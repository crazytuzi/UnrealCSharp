...
#define UE_IS_RUNNING_COOK_COMMANDLET !UE_VERSION_START(5, 0, 0)

#define UE_GET_ASSETS_BY_PATHS !UE_VERSION_START(5, 0, 0)

#define UE_LWC_TYPE UE_VERSION_START(5, 0, 0)

#define UE_TOOL_MENU UE_VERSION_START(5, 0, 0)
